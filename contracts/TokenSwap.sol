...
contract TokenSwap {
    ...
    /**
     * @dev Emitted when `swapExactInputMultihop` is called and successfully executes a multihop swap, returning the amount of `WETH9` received.
     * @param amountOut The amount of `WETH9` received by the caller.
     */
    event swapExactInputMultihopEvent(uint256 amountOut);

    /**
     * @dev Emitted when `swapExactOutputMultihop` is called and successfully executes a multihop swap, returning the amount of `DAI` spent.
     * @param amountIn The amount of `DAI` spent by the caller.
     */
    ...
    function swapExactInputMultihop(
        ...
        emit swapExactInputMultihopEvent(amountOut);
    }
    ...
    function swapExactOutputMultihop(
        ...
        emit swapExactOutputMultihopEvent(amountIn);
    }
}
